      ...
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <form method="POST" action="/" enctype="multipart/form-data"> 
            @csrf
            {{-- enctype="multipart/form-data  extramente necessario para enviar dados, arquivo, e formularios --}}
            {{-- Usa-se o name para refenciar o arquivo... id=" é apenas o identificador unico dele" --}}
